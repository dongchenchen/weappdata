...
Component({
    ...
    data: {
        baseCanvasID: 'wxChartComponent_circlechart_base',
        floatCanvasID: 'wxChartComponent_circlechart_float',
        w: '300',
        h: '200',
        chartStatus: '0',
        legend: {show: false}
    ...
    methods: {
        draw: function () {
            ...
            if (!this.chartHandle)
                this.chartHandle = new Handle(this.data, this.baseCtx);

            console.log("come here methods:draw: ", this.data);
            //
            // if(DEBUGLEVLE < 1){
            //     console.log("come here methods:draw: ", this.data);
            // }
